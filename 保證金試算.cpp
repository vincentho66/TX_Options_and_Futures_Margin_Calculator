...
int init_stock_futures(int stock_price, int margin_type) {
...
int maintain_stock_futures(int stock_price, int margin_type) {
...
int liquidation_stock_futures(int stock_price, int margin_type) {
